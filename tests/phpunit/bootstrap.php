...
// Make CRM_Mods_ExtensionUtil available.
require_once __DIR__ . '/../../mods.civix.php';
...
addExtensionToClassLoader('com.proveg.mods');
 ...
 */
function _mods_test_civicrm_container(ContainerBuilder $container): void {
}
